  ...
  render() {
    ...
    return (
      <div className="col-8">
        ...
        <MDBDataTable data={data} striped info={false} entries={6} displayEntries={false} noBottomColumns theadTextWhite>
        <MDBTableHead color="primary-color" textWhite></MDBTableHead>
        </MDBDataTable>

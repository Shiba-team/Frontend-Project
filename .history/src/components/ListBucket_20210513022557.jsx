  ...
  render() {
    ...
    return (
      <div className="col-8">
        ...
        <MDBDataTableV5 hover data={data} striped info={false} paging={false} scrollY scrollX={false} entries={5} displayEntries={false} noBottomColumns materialSearch theadColor="bg-info" theadTextWhite maxHeight="350px" barReverse>
        </MDBDataTableV5>

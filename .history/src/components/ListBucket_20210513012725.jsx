  ...
  render() {
    ...
    return (
      <div className="col-8">
        ...
        <MDBDataTableV5 id="#sort" hover data={data} striped info={false} entries={6} displayEntries={false} noBottomColumns materialSearch theadColor="bg-info" theadTextWhite maxHeight="350px" barReverse>
        </MDBDataTableV5>

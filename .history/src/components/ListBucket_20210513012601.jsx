  ...
  render() {
    ...
    return (
      <div className="col-8">
        ...
        <MDBDataTable id="#sort" hover data={data} striped info={false} entries={6} displayEntries={false} noBottomColumns theadColor="bg-info" theadTextWhite maxHeight="350px" searchTop={false} searchBottom barReverse>
        </MDBDataTable>

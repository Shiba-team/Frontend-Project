...
const data = [{ id: 1, bucketName: 'Conan the Barbarian', lastUpdate: '1982' },{  id: 2, bucketName: 'Conan the Barbarian', lastUpdate: '1982' } ];
  ...
  render() {
    return (
      <div className="col-8">
        ...
        <div>
          <DataTable columns={columns} data={this.state.buckets} noHeader={true} striped={true}/>

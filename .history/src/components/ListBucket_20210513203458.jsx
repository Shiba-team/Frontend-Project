...
class ListBucket extends Component {
  ...
  addDeleteButton = (id) =>{
    ...
    return (
      <button id={`button_`+id} type="button" className={buttonClass} onClick={()=> this.deleteRow(id)}></button>)
    else return;
  }
  ...
  render() {
    ...
    return (
      <div className="col-8 position-relative" style={{height: 600}}>
        ...
        <MDBDataTableV5 hover data={data} striped info={false} paging= {false} scrollY entries={5} displayEntries={false} noBottomColumns materialSearch theadColor="bg-info" theadTextWhite maxHeight="350px" barReverse>
        </MDBDataTableV5>

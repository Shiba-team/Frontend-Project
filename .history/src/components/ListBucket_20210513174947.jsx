...
class ListBucket extends Component {
  ...
  addDeleteButton = (id) =>{
    ...
    return (
      <button type="button" className="btn btn-danger" onClick={(event)=> {event.stopPropagation();event.currentTarget.classList.add('disabled');this.deleteRow(id)}}><i class="fa fa-trash"></i></button>)
    else return;
  }

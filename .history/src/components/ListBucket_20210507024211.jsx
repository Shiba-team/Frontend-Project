...
class ListBucket extends Component {
  ...
  buildRow = (bucket) =>{
    ...
    return (
      ...
      <td className="row"> <div className="col-10 my-auto">{bucket.lastUpdate}</div> <div className="col-2 my-auto">{this.addDeleteButton(id)}</div></td>
      </tr>
    )
  }
  ...
  addDeleteButton = (id) =>{
    ...
    return (
      <button type="button" className="btn btn-danger alignButton" onClick={this.deleteRow()}><i class="fa fa-trash"></i></button>)
    else return;
  }

...
class ListBucket extends Component {
  ...
  deleteRow = (id) => {
    bin.push(this.props.buckets[listBucket.findIndex((i) => i.id === id)]);
  ...
  hideDeleteAction = () => {
    this.props.setBinBucket(bin, listBucket);
    this.props.hideDeleteAction();
  }
  ...
  render() {
    ...
    return (
      <div className="col-8">
        <CrudButton open={this.props.open} showDeleteAction={this.props.showDeleteAction} hideDeleteAction={this.hideDeleteAction} showDelete = {this.props.showDelete}/>

  ...
  render() {
    ...
    return (
      <div className="col-8">
        ...
        <MDBDataTable hover data={data} striped info={false} entries={6} displayEntries={false} noBottomColumns theadColor="indigo" theadTextWhite maxHeight="350px" scrollY>
        </MDBDataTable>

...
class ListBucket extends Component {
  ...
  addDeleteButton = (id) =>{
    ...
    return (
      <button id={button} type="button" className={ (deleteButton.indexOf(id)<0) ? buttonClass : "btn btn-danger disabled"} onClick={()=> this.deleteRow(id)}><i class="fa fa-trash"></i></button>)
    else return;
  }

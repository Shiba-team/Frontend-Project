...
class ListBucket extends Component {
  ...
  makeArray = () =>{
    ...
    this.setState({
      ...
      for (let i = 0; i < buckets.length; i++){
        let bucket = {
          ...
          lastUpdate: (<div className="row"><div className="col-10 my-auto" >{buckets[i].lastUpdate}</div> <div className="col-2 my-auto"><button type="button" className="btn btn-danger alignButton" onClick={()=> this.props.deleteRow(bucket[i].id)}><i class="fa fa-trash"></i></button>)</div></div>),
        }
    ...
    console.log(this.state.listbuckets)
  }
